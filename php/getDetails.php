...
//$qry = "SELECT u.studName, s.* FROM sessions s, students u WHERE u.studId=s.studId AND s.sessionId=".$_GET['sessionId']." LIMIT 1"; <--Temporarily removed for testing --Jens
$qry = "SELECT * FROM sessions WHERE sessionId=1";
